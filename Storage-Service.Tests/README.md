...
Dieses Projekt enthält **7 Unit-Tests und 1 vollständigen Anwendungstest** in C# mit xUnit.
...
├── Run-E2E.ps1                        ← Starthelfer für alle Tests
├── Unit/                             ← sieben schnelle Tests mit simulierten Daten
...
|---|---|---|
| Speichern und Fehler | [SupabaseChatMessageStoreTests.cs](Unit/SupabaseChatMessageStoreTests.cs) | Drei Tests: Raum bereitstellen, Fehler dabei, Fehler beim Speichern |
...
| Empfänger korrekt speichern | [ReceiverMappingTests.cs](Unit/ReceiverMappingTests.cs) | Drei Tests: A → B und B → A korrekt zuordnen; ungültige oder identische Empfänger-ID ablehnen |
...
| Alle Tests starten | [Run-E2E.ps1](Run-E2E.ps1) | Einstellungen vorbereiten und anschließend `dotnet test` aufrufen |
...
Der Helfer fragt fehlende Testdaten ab, das Passwort verdeckt. Bei Erfolg: **8 bestanden,
